...
quartiles2<-quantile(data_no_outlier$`uploads`, probs = c(.25, .75))
IQR2<-IQR(data_no_outlier$`uploads`)
Lower<-quartiles2[1]-1.5*IQR2
Upper<-quartiles2[2]+1.5*IQR2
...
Lower<-quartiles3[1]-1.5*IQR3
Upper<-quartiles3[2]+1.5*IQR3
